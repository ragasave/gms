                ...
                <div class="footer-cols">
                    ...
                    <div class="footer-col">
                        ...
                        <ul class="footer-items">
                            ...
                            <li>
                                <a class="social-icon si-facebook" href="https://www.facebook.com/GlocalMSPL/">
                                    <svg>
                                        <use xlink:href="#icon-facebook-with-circle"></use>
                                    </svg>
                                </a>
                                <a class="social-icon si-instagram" href="https://www.instagram.com/GlocalMSPL/">
                                    <svg>
                                        <use xlink:href="#icon-instagram-with-circle"></use>
                                    </svg>
                                </a>
                                <a class="social-icon si-twitter" href="">
                                    <svg>
                                        <use xlink:href="#icon-twitter-with-circle"></use>
                                    </svg>
                                </a>
                                <a class="social-icon si-youtube" href="">
                                    <svg>
                                        <use xlink:href="#icon-youtube-with-circle"></use>
                                    </svg>
                                </a>
                                <a class="social-icon si-linkedin" href="https://www.linkedin.com/company/glocalmspl">
    ...
    <style>
        ...
        .social-icon.si-facebook svg {
            fill: #3B5998;
        }
        .social-icon.si-instagram svg {
            fill: #125688;
        }
        .social-icon.si-twitter svg {
            fill: #55ACEE;
        }
        .social-icon.si-youtube svg {
            fill: #bb0000;
        }
        .social-icon.si-linkedin svg {
            fill: #007bb5;
        }
    </style>